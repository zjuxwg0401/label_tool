...
parentpath = '/Users/shallwego2/Pictures/seq10/' #"Directory path with parent dir before xml_dir or img_dir"
addxmlpath = parentpath+"xml_label"  #Directory path with XML files"
addimgpath = parentpath  #"Directory path with IMG files"
outputpath = parentpath + "yolo_label/"  #"output folder for yolo format"
